                ...
                <div className={styles.wrapperPage}>
                    <section className={styles.mainSectionWrapper}>
                        ...
                        <div className={styles.rightCol}>
                            ...
                            <h1 className={styles.mainTitle}>Дмитрий <br /> Бадеев</h1>
                        </div>
                    </section>
                            ...
                            <Col span={16}>
                                <Row justify="space-between">
                                    <Col span={11}>
                                        ...
                                        <Paragraph>
                                            Привет! Я&nbsp;веб-разработчик. Моя сфера деятельности&nbsp;&mdash; это все, что связано со&nbsp;всемирной
                                            паутиной: сайты, веб-приложения, программные веб-интерфейсы. Я&nbsp;профессионально занимаюсь разработкой
                                    ...
                                    <Col span={11}>
                                        ...
                                        <Card className="mt-40 p-40">
                                            ...
                                            <Paragraph className="mt-20">
                                                Задизайню и сверстаю сайт, адаптирую
                                                его под все телефоны, планшеты,
                                                мониторы и заставлю это все работать
                                                одинаково во всех браузерах.
                                            </Paragraph>
                                            <TagList tagList={['HTML', 'CSS', 'SaSS', 'SCSS', 'LESS',
                                                'PostCSS', 'JS', 'TypeScript', 'ReactJS', 'Webpack', 'Gulp', 'Дизайн']} />
                                        </Card>
                                    </Col>
                                    <Col span={11}>
                                        <Title level={2} style={{ opacity: 0, cursor: "default" }}>Навыки</Title>
                                        <Card className="mt-40 p-40">
                                            <Title level={4}>Backend</Title>
                                            <Line />
                                            <Paragraph className="mt-20">
                                                Напишу сложную бизнес-логику, настрою
                                                CMS, организую базу данных и заставлю
                                                большую и сложную систему работать,
                                                как часы.
                                            </Paragraph>
                                            <TagList tagList={['C#', 'ASP.NET Core', 'REST API', 'ООП', 'Entity Framework',
                                                'CMS', 'Базы данных', 'MSSql', 'PostgreSql']} />
                                        </Card>
                                    </Col>
                                </Row>
                            </Col>
