...
export type WorkByIdQuery = { __typename?: "Queries" } & {
    workById?: Maybe<
        { __typename?: "Work" } & Pick<Work, "id" | "title" | "date" | "imgPath" | "html" | "link" | "task"> & {
                authors?: Maybe<Array<Maybe<{ __typename?: "Author" } & Pick<Author, "id" | "name" | "link" | "role">>>>
            }
    >
}
...
export function useTagsByWorkIdLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<TagsByWorkIdQuery, TagsByWorkIdQueryVariables>
) {
    return ApolloReactHooks.useLazyQuery<TagsByWorkIdQuery, TagsByWorkIdQueryVariables>(
        TagsByWorkIdDocument,
        baseOptions
    )
}
...
export function useWorksLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<WorksQuery, WorksQueryVariables>
) {
 ...
 * });
 */
export function useWorkByIdQuery(
    baseOptions?: ApolloReactHooks.QueryHookOptions<WorkByIdQuery, WorkByIdQueryVariables>
) {
    return ApolloReactHooks.useQuery<WorkByIdQuery, WorkByIdQueryVariables>(WorkByIdDocument, baseOptions)
}
export function useWorkByIdLazyQuery(
    baseOptions?: ApolloReactHooks.LazyQueryHookOptions<WorkByIdQuery, WorkByIdQueryVariables>
) {
